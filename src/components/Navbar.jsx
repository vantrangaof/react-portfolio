    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        <Link // when the user clicks the logo > back to homepage, scroll to top
          ...
          <p className="text-white text-[18px] font-bold cursor-pointer flex">Trang &nbsp;
        ...
        <div className="sm:hidden flex flex-1 justify-end items-center">
            <img src={toggle ? close : menu} // hamburger menu for mobile
                    ...
                    <li key={link.id}
                        className={ // check if the nav link is active
                          `${
                            ...
                            ? "text-white"
                            : "text-secondary"
                          } font-poppins font-medium cursor-pointers text-[16px]`
                        }
                        onClick={() => {
                          setToggle(!toggle);
